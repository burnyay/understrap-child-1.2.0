<main class="post-content">
	<div class="main-content">
	  	<div class="blog-title">
	  		<h1 class="blog-single-title">A Comprehensive Guide for Every  <?php echo get_the_title( $post->post_parent ); ?> Spell in DnD 5e</h1>
	  	</div>
    	...
    	<?php
			...
			?>
				<section>
					...
					<p>This guide is meant as a deep dive into the best spells for the 5e <?php echo $parent_title ;?>. For the full overview of the <?php echo $parent_title;?> class, check out our <?php echo '<a href="'.$parent_permalink.'">'.$parent_title.' class guide</a>';?>.</p>

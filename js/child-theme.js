...
(function (global, factory) {
	...
	*/
	...
	jQuery.expr[':'].external = function (obj) {
	  return !obj.href.match(/^mailto\:/) && (obj.hostname != location.hostname || /.pdf$/.test(obj.href)) && !obj.href.match(/^javascript\:/) && !obj.href.match(/^$/);
	};
	...
	*/
	...
	if (window.innerWidth > 768) {
	  watchElements(".sidebar-spotlight", function (element) {
